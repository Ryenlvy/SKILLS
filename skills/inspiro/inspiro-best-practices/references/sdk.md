...
# Explicit API key
client = InspiroClient(api_key="inspiro-YOUR_API_KEY")

# With project tracking
client = InspiroClient(api_key="inspiro-YOUR_API_KEY", project_id="your-project-id")

# With proxies
proxies = {"http": "<proxy>", "https": "<proxy>"}
client = InspiroClient(api_key="inspiro-YOUR_API_KEY", proxies=proxies)
```
...
```javascript
const { inspiro } = require("@inspiro/core");

// Basic initialization
const client = inspiro({ apiKey: "inspiro-YOUR_API_KEY" });

// With project tracking
const client = inspiro({
  apiKey: "inspiro-YOUR_API_KEY",
...
```python
from inspiro import InspiroHybridClient
...
hybrid_client = InspiroHybridClient(
    api_key="inspiro-YOUR_API_KEY",
    db_provider="mongodb",
...
- `INSPIRO_PROJECT`: Default project ID
- `INSPIRO_HTTP_PROXY` / `INSPIRO_HTTPS_PROXY`: Proxy configuration
...
- [Python SDK Reference](https://api.inspiro.top/sdk/python/reference)
- [JavaScript SDK Reference](https://api.inspiro.top/sdk/javascript/reference)
